...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SoldTicket.seat'
        db.delete_column(u'core_soldticket', 'seat')

        # Adding field 'SoldTicket.created_date'
        db.add_column(u'core_soldticket', 'created_date',
                      self.gf('django.db.models.fields.BigIntegerField')(default=1390276791966),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SoldTicket.seat'
        db.add_column(u'core_soldticket', 'seat',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=45),
                      keep_default=False)

        # Deleting field 'SoldTicket.created_date'
        db.delete_column(u'core_soldticket', 'created_date')
    ...
    models = {
        ...
        'core.event': {
            ...
            'created_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390276791959'}),
            'description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'end_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390276791958'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390276791959'}),
        ...
        'core.soldticket': {
            ...
            'created_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390276791966'}),
