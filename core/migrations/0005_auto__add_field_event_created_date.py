...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.created_date'
        db.add_column(u'core_event', 'created_date',
                      self.gf('django.db.models.fields.BigIntegerField')(default=1390050837637),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.created_date'
        db.delete_column(u'core_event', 'created_date')
    ...
    models = {
        ...
        'core.event': {
            ...
            'created_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390050837637'}),
            'description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'end_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390050837637'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390050837637'}),
