...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TicketType.price'
        db.alter_column(u'core_tickettype', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'TicketType.price'
        db.alter_column(u'core_tickettype', 'price', self.gf('django.db.models.fields.DecimalField')(max_length=2, max_digits=2, decimal_places=2))
    ...
    models = {
        ...
        'core.event': {
            ...
            'end_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390049324805'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390049324805'}),
