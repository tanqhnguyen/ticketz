...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_soldticket', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='tickets', to=orm['core.Event']),
                      keep_default=False)
    ...
    models = {
        ...
        'core.event': {
            ...
            'created_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390385118055'}),
            'description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'end_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390385118054'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390385118055'}),
        ...
        'core.soldticket': {
            ...
            'created_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390385118143'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tickets'", 'to': "orm['core.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
