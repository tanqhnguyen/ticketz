...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SoldTicket.code'
        db.add_column(u'core_soldticket', 'code',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=36),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SoldTicket.code'
        db.delete_column(u'core_soldticket', 'code')
    ...
    models = {
        ...
        'core.event': {
            ...
            'created_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390281594733'}),
            'description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'end_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390281594733'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390281594733'}),
        ...
        'core.soldticket': {
            ...
            'code': ('django.db.models.fields.TextField', [], {'max_length': '36'}),
            'created_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390281594736'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ticket_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.TicketType']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sold_tickets'", 'to': "orm['core.User']"})
        },
        'core.tickettype': {
