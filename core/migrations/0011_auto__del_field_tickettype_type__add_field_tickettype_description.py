...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TicketType.type'
        db.delete_column(u'core_tickettype', 'type')

        # Adding field 'TicketType.description'
        db.add_column(u'core_tickettype', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TicketType.type'
        db.add_column(u'core_tickettype', 'type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=45),
                      keep_default=False)

        # Deleting field 'TicketType.description'
        db.delete_column(u'core_tickettype', 'description')
    ...
    models = {
        ...
        'core.event': {
            ...
            'created_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390383623562'}),
            'description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'end_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390383623561'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390383623562'}),
        ...
        'core.soldticket': {
            ...
            'created_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390383623654'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
