...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SoldTicket.is_used'
        db.add_column(u'core_soldticket', 'is_used',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding unique constraint on 'SoldTicket', fields ['code']
        db.create_unique(u'core_soldticket', ['code'])


    def backwards(self, orm):
        # Removing unique constraint on 'SoldTicket', fields ['code']
        db.delete_unique(u'core_soldticket', ['code'])

        # Deleting field 'SoldTicket.is_used'
        db.delete_column(u'core_soldticket', 'is_used')
    ...
    models = {
        ...
        'core.event': {
            ...
            'created_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390321898666'}),
            'description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'end_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390321898666'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390321898666'}),
        ...
        'core.soldticket': {
            ...
            'created_date': ('django.db.models.fields.BigIntegerField', [], {'default': '1390321898765'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
